...
const ALLOWED_AUDIO_TYPES = ['audio/mpeg', 'audio/mp4', 'audio/m4a', 'audio/x-m4a', 'audio/wav', 'audio/webm', 'audio/ogg', 'audio/aac', 'audio/mp4a-latm', 'audio/3gpp', 'audio/3gpp2', 'audio/amr', 'application/octet-stream'];
