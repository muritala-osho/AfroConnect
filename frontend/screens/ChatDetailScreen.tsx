...
export default function ChatDetailScreen({
  ...
  return (
    <ThemedView style={[styles.container, { paddingTop: insets.top }]}>
      ...
      {/* BODY */}
      <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === "ios" ? "padding" : "height"} keyboardVerticalOffset={Platform.OS === "ios" ? insets.top + 68 : 0} enabled={Platform.OS !== "web"}>ef,
  useLayoutEffect,
  useCallback,
  useMemo,
} from "react";
...
>>>>>>> 25ec1b0 (Fix chat input alignment with keyboard for smoother user interaction)
        {currentTheme?.image ? (
